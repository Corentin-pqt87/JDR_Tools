...
from character_maker.script.qcm import qcm
from character_maker.script.class_character import *
from character_maker.script.class_arme import *
from character_maker.script.class_armure import *
# jdr tools\character_maker\Tk\qcm_Tk.py
# -*- coding: utf-8 -*-
...
# Ce fichier est  la version Tkinter du questionnaire de création de personnage
# La fenêtre contient une boite de dialogue qui permet de répondre aux questions du questionnaire dans le bas de la fenêtre
# Sur la partie haute de la fenêtre ce trouve la qustion et les choix possibles
# Objectif : récupérer les qustions de la fonction qcm() et les afficher dans la fenêtre Tkinter
def qcm_Tk():
    # fenetre principale
    root = Tk()
    root.title("Création de personnage D&D 5e")
    root.geometry("600x400")
    # Création d'un cadre pour les questions
    frame_questions = Frame(root)
    frame_questions.pack(pady=20)

    # Création d'un cadre pour les réponses
    frame_reponses = Frame(root)
    frame_reponses.pack(pady=20)

    # Création d'un bouton pour valider les réponses
    bouton_valider = Button(root, text="Valider", command=valider_reponses)
